...
async function generateReceiptWithQR() {
  ...
  cmd.push(...encode('Barcode: BABYLON-2025'));
  cmd.push(LF, LF);
  ...
  try {
    ...
    client.on('connect', () => {
      ...
      client.write(receipt, () => {
        ...
        console.log(`  1. "BABYLON" header (2x2, bold)`);
        console.log(`  2. "Ravintola" subtitle`);
        console.log(`  3. QR code (scannable square)`);
        console.log(`  4. "ravintolababylon.fi" below QR`);
        console.log(`  5. Fallback barcode text\n`);
        console.log(`Try scanning the QR code with your phone!`);
        console.log(`It should open: https://ravintolababylon.fi\n`);
