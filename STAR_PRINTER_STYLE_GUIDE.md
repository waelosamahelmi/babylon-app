...
### Parameter Order
⚠️ **CRITICAL:** Parameters are `height × width` (NOT width × height)
...
### Data Format
Any text string:
- URLs: `https://ravintolababylon.fi`
...
// QR code
qrCode(cmd, 'https://ravintolababylon.fi/order/1234');
newline(cmd, 2);
...
// QR Code - Centered
qrCode(cmd, 'https://ravintolababylon.fi');
newline(cmd, 2);
