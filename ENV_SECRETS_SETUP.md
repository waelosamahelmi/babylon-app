...
Go to: https://github.com/waelosamahelmi/babylon-app/settings/secrets/actions
...
| Secret Name | Value from .env |
|-------------|-----------------|
| `VITE_API_URL` | `https://babylon-admin.fly.dev` |
| `VITE_WS_URL` | `ws://localhost:5000` |
| `VITE_SERVER_URL` | `https://babylon-admin.fly.dev` |
| `VITE_EMAIL_API_URL` | `https://babylon-admin.fly.dev` |

#### App Configuration
| Secret Name | Value from .env |
|-------------|-----------------|
| `VITE_APP_NAME` | `Ravintola Babylon - Kitchen Admin` |
| `VITE_ANDROID_PACKAGE` | `com.ravintola.babylon.admin` |
...
| `HOSTINGER_FTP_USER` | `u608790032.ravintolababylon` |
| `HOSTINGER_FTP_PASSWORD` | `Babylon@2025!` |
...
2. Check workflow at: https://github.com/waelosamahelmi/babylon-app/actions
